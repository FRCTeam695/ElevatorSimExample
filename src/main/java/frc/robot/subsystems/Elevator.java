...
public class Elevator implements AutoCloseable {
  ...
  public void updateTelemetry() {
    ...
    SmartDashboard.putNumber("ElevatorPosition", m_encoder.getDistance());
    SmartDashboard.putNumber("ElevatorGoal", m_controller.getGoal().position);
    SmartDashboard.putNumber("ElevatorSetpoint", m_controller.getSetpoint().position);
    SmartDashboard.putNumber("ElevatorSetpointVelocity", m_controller.getSetpoint().velocity);
  }
